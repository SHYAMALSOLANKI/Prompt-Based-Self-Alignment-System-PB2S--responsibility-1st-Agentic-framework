...
A bounded, pre‑emission self‑audit loop so each reply is contradiction‑aware and policy‑aligned, with a verifiable proof object attached.
...
Prefer providers that allow predictable reflection and no hidden prompt overrides. Document model/version/settings in your README.

---

*This single file satisfies the requirement to **explicitly prove and document** the four‑step structure. You can keep this single file, or later split it into `/SPECIFICATION`, `/schemas`, and `/tests` as your repo grows.*
